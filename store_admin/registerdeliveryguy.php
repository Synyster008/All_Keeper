...
<head>
  <title>Register Delivery Guy - Storekeeper Dashboard</title>
  ...
  <div class="main-content">
    ...
    <div class="header bg-background pb-6 pt-5 pt-md-6">
      <div class="container-fluid">
        ...
        <?php if (isset($_SESSION['deliveryguy_registered'])) : ?>
          <div class="alert alert-success alert-dismissible fade show" role="alert">
            <span class="alert-inner--icon"><i class="ni ni-like-2"></i></span>
            <?php echo $_SESSION['deliveryguy_registered'];
            unset($_SESSION['deliveryguy_registered']); ?>
            </span>
        ...
        <div class="col-xl-12 order-xl-1">
          <div class="card bg-secondary shadow">
            <div class="card-header bg-white border-0">
              <h3 class="mb-0">Register New Delivery Guy</h3>
            </div>
            <div class="card-body pb-5">
              <form method="POST" autocomplete="off" action="storekeeperhandler.php">
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" name="regName" id="input-id" class="form-control" required placeholder="Deliveryguy Name">
                      </div>
                    </div>
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        <label class="form-control-label" for="input-requestid">Schedule<span class="text-danger">*</span></label>
                  ...
                  <button name="regdeliveryguySubmit" class="btn btn-icon btn-3 btn-primary" type="submit">

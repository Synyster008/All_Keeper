<?php 
  ...
  $storerequestCount = getStoreRequest($_SESSION['rollnumber'], $db);
    ...
    <div class="col-lg-3 col-md-5">
      <div class="card card-stats mb-4 mb-xl-0">
        <div class="card-body">
          <div class="row">
            <div class="col">
              <h5 class="card-title text-uppercase text-muted mb-0">Store Requests</h5>
              <span class="h2 font-weight-bold mb-0"><?php echo $storerequestCount['count(*)']; ?></span>
            </div>
            <div class="col-auto">
              <div class="icon icon-shape bg-primary text-white rounded-circle shadow">
          ...
          <p class="mt-3 mb-0 text-muted text-sm">
            <span class="text-success mr-2"><i class="fa fa-arrow-up"></i> <?php echo $storerequestCount['count(*)']; ?></span>
            <span class="text-nowrap">Since last week</span>
          </p>
        </div>
      </div>

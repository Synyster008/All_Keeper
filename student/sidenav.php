      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" href="index.php">
            <i class="ni ni-tv-2"></i>Housekeeper Dashboard
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="indexstationery.php">
            <i class="ni ni-tv-2"></i>Storekeeper Dashboard
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="request.php">
            <i class="ni ni-send"></i>Clean Request
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="requestStorekeeper.php">
            <i class="ni ni-archive-2"></i>Stationery Request
          </a>
        </li>
        <li class="nav-item">
